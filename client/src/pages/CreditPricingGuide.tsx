      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-3 rounded-xl" style={{
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className={item.highlight ? "text-white font-semibold" : "text-foreground/80"}>{item.label}</span>
                </div>
                <Badge variant="outline" className={item.highlight ? "border-amber-500 text-amber-400" : "border-white/20 text-muted-foreground"}>
                  {item.cost}
                </Badge>
              </div>
            ))}
                ...
                {[
                  ...
                  <tr key={i} style={{ background: row.highlight ? "rgba(201,168,76,0.06)" : i % 2 === 0 ? "rgba(255,255,255,0.02)" : "transparent" }}>
                    <td className="p-3 text-foreground">
                      {row.length}
                      <Badge variant="outline" className="ml-2 text-xs border-white/20 text-muted-foreground/70">{row.badge}</Badge>
                    </td>
                    <td className="p-3 text-center font-bold" style={{ color: GOLD }}>{row.rate}</td>
                    <td className="p-3 text-center text-muted-foreground">{row.scenes}</td>
              ...
              <div key={i} className="p-4 rounded-xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground/70 mt-1">{tool.detail}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <Section title="Before you build — what to expect">
          ...
          <div className="p-5 rounded-xl mb-4" style={{ background: "rgba(201,168,76,0.08)", border: `1px solid ${GOLD}` }}>
            <div className="text-sm text-muted-foreground mb-2">Example cost breakdown (WizPilot)</div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-foreground/80">26 scenes × 18 credits/scene</span>
              <span className="font-bold text-white">468 credits</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground/70">Your current balance</span>
              <span className="text-muted-foreground">600 credits</span>
            </div>
            <div className="flex items-center justify-between text-sm mt-1">
              <span className="text-muted-foreground/70">Balance after build</span>
