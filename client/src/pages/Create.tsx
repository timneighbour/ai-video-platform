...
const TOOLS: Tool[] = [
  {
    ...
    description: "Turn any track into a full-length, AI-directed music video \u2014 scenes, cuts, and all. Upload any track and our AI writes a lyrics-synced storyboard, generates every scene, and assembles a complete music video in minutes.",
  ...
  },
  {
    ...
    description: "Write each scene prompt manually for full creative control. Choose your renderer (WizGenesis for speed, WizBoost for quality) and render each scene individually.",
    href: "/wiz-script",
    emblem: <WizScriptEmblem size={40} />,
    bg: IMG.epicFantasy,
    bgAlt: IMG.horror,
  ...
  },
  {
    ...
    badge: "New",
    badgeStyle: "gold",
    tagline: "AI short-form video for Shorts, TikTok & Reels",
