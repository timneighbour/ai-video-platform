...
const BRAND = {
  ...
  badge: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-violet-400/30 bg-violet-500/10 text-violet-300 text-xs font-mono tracking-[0.18em] uppercase font-semibold",
...
export default function LandingUK() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white font-sans overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 border-b border-white/5 bg-black/60 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="bg-violet-600 hover:bg-violet-500 text-white font-semibold px-5 py-2 rounded-xl text-sm transition-colors"
          >
            Start Creating
          </a>
        </div>
      ...
      {/* ── WizSound callout ── */}
      <section className="py-16 px-6 bg-gradient-to-r from-violet-950/40 via-[#0f0f18] to-fuchsia-950/30 border-t border-white/6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-fuchsia-500/30 bg-fuchsia-500/10 text-fuchsia-300 text-sm font-semibold mb-5">
