...
const TIMELINE_STAGES = [
 ...
 { num: "06", icon: "", label: "Export", desc: "Download, share, or publish directly", img: IMGS.frame5 },
];
...
const FAQS = [
 ...
 { q: "Can I use the videos commercially?", a: "Yes — all generated videos are yours to download and use in your own projects, including streaming platforms, social media, broadcast, and live events. Full licensing terms are under review and will be published shortly." },
...
export default function WizVideoProductPage() {
 ...
 <NavLink href="/" className="hidden md:inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold text-white/40 hover:text-white/70 transition-colors">Home
 </NavLink>
 <NavLink
 ...
 >
 <Film className="w-3.5 h-3.5" />Create Music Video
 </NavLink>
 </div>
 </div>
 </nav>
 ...
 >
 <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: ACCENT }} />REC
 </div>
 {/* Film frames */}
 ...
 {/* Scene label */}
 <div className="absolute bottom-1 left-3 right-3 text-center text-[8px] font-bold text-white/60">SCENE {String(i + 1).padStart(2, "0")}
 </div>
 </div>
 ))}
 {/* Take counter */}
 ...
 style={{ border: `1px solid ${ACCENT}30`, background: `${ACCENT}08`, color: ACCENT }}
 >
 <Film className="w-3 h-3" />The Music Video Studio
 </div>
 <h1 className="text-5xl md:text-6xl font-black leading-[1.05] mb-6 text-white">Your music.<br />
 <span style={{ color: ACCENT }}>A cinematic</span><br />
 music video.
 </h1>
 <p className="text-white/55 text-base leading-relaxed mb-10 max-w-lg">Turn your audio track into a full cinematic music video — beat-locked, colour-graded, 4K. No editing skills required.
 </p>
 ...
 >
 <Film className="w-4 h-4" />Create Your Music Video
 ...
 >
 <Film className="w-3 h-3" />Director's Timeline
 </div>
 <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">From audio file to finished video
 </h2>
 <p className="text-white/40 text-base max-w-xl mx-auto">Every WizVideo™ build follows the same cinematic production pipeline — fully automated, stage by stage.
 </p>
 </div>
 ...
 <div>
 <h2 className="text-3xl font-extrabold text-white mb-6 leading-tight">A full music video production pipeline — automated
 </h2>
 <p className="text-white/50 text-base leading-relaxed mb-8">WizVideo™ is WIZ AI's dedicated music video generation engine. It analyses your audio track — BPM, key, mood, and structure — and generates a complete cinematic music video with beat-locked visuals, dynamic camera movement, and professional colour grading.
 </p>
 ...
 <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">Ready to create your music video?
 </h2>
 <p className="text-white/45 text-base mb-8 max-w-xl mx-auto">Upload your track and WizVideo™ will have a cinematic music video ready in under 10 minutes.
 </p>
 <NavLink
 href={WIZVIDEO_STUDIO_PAGE}
