      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div className="hidden lg:block">
            ...
            >
              <span className="text-xs font-black tracking-[0.3em] uppercase" style={{ color: ACCENT, fontFamily: "'Courier New', Courier, monospace" }}>
                FADE IN:
              </span>
        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
              Prompt → Screenplay → Storyboard
            </h2>
            <p className="text-white/40 text-base max-w-xl mx-auto">
              See the full WizScript™ pipeline in action — from a single sentence to a production-ready screenplay and storyboard.
            </p>
          </div>
          <ScriptPreviewPanel />
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-white/45 text-base mb-8 max-w-xl mx-auto">
            One prompt. A full screenplay, storyboard, and production pipeline — ready in under 5 minutes.
          </p>
          <NavLink
            href={WIZSCRIPT_STUDIO_PAGE}
