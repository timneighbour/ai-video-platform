...
const WIZCREATE: ProductPageProps = {
 ...
 logo: `${CDN}/wizcreate-logo-new_85a25756_f4aa29bb.png`,
...
const WIZANIMATE: ProductPageProps = {
 ...
 logo: `/manus-storage/wizanimate-logo-new_a84f9808_a089857a.png`,
 accentFrom: "from-muted-foreground",
...
const WIZSOUND: ProductPageProps = {
 ...
 logo: `${CDN}/wizsound-logo-new_c5cced65_d334a3bb.png`,
 accentFrom: "from-muted-foreground",
...
const WIZLUMINA: ProductPageProps = {
 ...
 headline: "See the difference — cinema-grade visuals, every frame",
 subheadline: "WizLumina™ applies cinematic colour grading, HDR tone mapping, and film-level sharpening to transform every frame into rich, vivid, cinema-quality visuals.",
 logo: `${CDN}/wizlumina-logo-new_0709f3c5_83ddc673.png`,
 accentFrom: "from-primary",
 ...
 whatItDoes: "WizLumina™ is WIZ AI's visual post-processing engine. It analyses each frame of your video and applies a cinematic enhancement pipeline — colour grading, HDR tone mapping, sharpening, and 4K upscaling — that transforms the output into rich, film-quality visuals.",
 capabilities: [
 ...
 benefits: [
 { title: "From flat to cinematic", desc: "WizLumina transforms every frame into rich, vivid, cinema-quality imagery with professional colour grading." },
 ...
 { icon: "layers", title: "Grain & Noise Management", desc: "Adaptive noise reduction removes generation artefacts and digital grain while preserving the organic texture that makes footage feel real." },
 { icon: "film", title: "Film Emulation Mode", desc: "Emulates the look of specific film stocks — Kodak Vision3, Fuji Eterna, Arri LogC — giving your video the unmistakable feel of shot-on-film." },
 ],
...
const WIZGENESIS: ProductPageProps = {
 ...
 logo: `${CDN}/wizgenesis-logo-new_9814b3d1_cabaf933.png`,
 accentFrom: "from-muted-foreground",
...
const WIZBOOST: ProductPageProps = {
 ...
 logo: `${CDN}/wizboost-logo-new_93f2b48b_b731a139.png`,
...
const WIZSYNC_INFO: ProductPageProps = {
 ...
 logo: `${CDN}/wizsync-logo-new_9563f007_70cef76a.png`,
