...
const WIZCREATE: ProductPageProps = {
  ...
  keyFeatures: [
    ...
    { icon: "layers", title: "Character Consistency Engine", desc: "Characters maintain the same appearance, proportions, and style across every scene — no drift, no inconsistency." },
...
const WIZANIMATE: ProductPageProps = {
  ...
  keyFeatures: [
    ...
    { icon: "eye", title: "Style-Adaptive Rendering", desc: "Switches seamlessly between Cinematic, Anime, 3D, and Illustrated styles — each with its own motion language and physics rules." },
    ...
    { icon: "arrow-right-circle", title: "WizSync-Ready Export", desc: "Animated scenes pass directly to WizSync™ for lip sync and voice assignment — no re-rendering or format conversion required." },
  ],
...
const WIZGENESIS: ProductPageProps = {
  ...
  keyFeatures: [
    ...
    { icon: "zap", title: "Cloud-Accelerated Rendering", desc: "Distributed cloud rendering infrastructure processes your video in parallel across multiple nodes — delivering studio-quality output in minutes, not hours." },
    ...
    { icon: "download", title: "Instant Delivery", desc: "Completed videos are available for immediate download or direct sharing to connected platforms the moment rendering is complete." },
  ],
...
const WIZSCRIPT: ProductPageProps = {
  ...
  benefits: [
    ...
    { title: "Seamless WizGenesis™ handoff", desc: "Your script flows directly into WizGenesis™ with no manual setup — from idea to builded video in one workflow." },
  ],
  keyFeatures: [
...
const WIZPILOT: ProductPageProps = {
  ...
  keyFeatures: [
    ...
    { icon: "zap", title: "Credits Only on Render", desc: "Storyboard generation and all regenerations are completely free. Credits are only deducted when you approve and trigger the final build." },
  ],
  heroImage: HERO_IMGS.wizcreate,
