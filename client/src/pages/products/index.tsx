...
const WIZLUMINA: ProductPageProps = {
  ...
  keyFeatures: [
    ...
    { icon: "zap", title: "AI Upscaling to 4K", desc: "Proprietary super-resolution upscaling increases resolution up to 4K while sharpening edges and recovering fine detail lost in the original render." },
...
const WIZGENESIS: ProductPageProps = {
  ...
  keyFeatures: [
    ...
    { icon: "shield-check", title: "Character Coherence Validation", desc: "Cross-checks character appearance, scene continuity, and narrative logic before rendering — catching inconsistencies that would otherwise require a full regeneration." },
