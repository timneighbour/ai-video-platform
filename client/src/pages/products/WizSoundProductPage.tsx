...
const IMG = {
  heroConsole:   "https://wiz-ai.b-cdn.net/studio-console_91324aaa.jpg",
  studioMic:     "https://wiz-ai.b-cdn.net/studio-mic_3d8c675d.jpg",
  studioMicDark: "https://wiz-ai.b-cdn.net/studio-mic-dark_bd0b6598.jpg",
  studioMoody:   "https://wiz-ai.b-cdn.net/studio-moody_02c867cc.jpg",
  concertHall:   "https://wiz-ai.b-cdn.net/concert-hall_2b6b946b.jpg",
  sphereConcert: "https://wiz-ai.b-cdn.net/sphere-concert_e0e5b1d0.jpg",
  ambientMusic:  "https://wiz-ai.b-cdn.net/ambient-music_efff5905.webp",
};
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-emerald-500/20 bg-emerald-500/10 text-[11px] font-bold tracking-[0.22em] uppercase text-emerald-400 mb-6">
              ...
              The Composer · Cinematic Audio Engine
            </div>

            <h1 className="text-4xl md:text-[3.25rem] font-black tracking-tight leading-[1.08] mb-6 text-white">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="text-center mb-12">
            ...
            <p className="text-white/40 text-base max-w-xl mx-auto">
              Same source track — three tiers of WizSound processing. Press play on any tier to hear the real difference.
            </p>
          </div>
          <WizSoundDemoPlayer />
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">
              From raw audio to cinematic sound — step by step
            </h2>
          </div>
      ...
      <section className="py-20 px-6 bg-[#060608]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">
              Why WizSound™ changes everything
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-extrabold text-white mb-3">
              Try it again — compare the tiers
            </h2>
