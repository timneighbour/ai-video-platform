      ...
      <section className="relative min-h-[92vh] flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-32 pb-12 w-full">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-[1.04] mb-6 text-white tracking-tight">
              Your music.<br />
              <span style={{ background: `linear-gradient(90deg, ${ACCENT}, #fb923c)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                A beat-locked
              </span><br />
              animation.
            </h1>
            <p className="text-white/55 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              WizAnimate™ generates a full animated music video from your audio track — AI characters, automatic lip sync, and every frame locked to your beat grid. No animation skills required.
            </p>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-white/50 text-lg mb-8 max-w-xl mx-auto">
            No animation skills. No timeline editing. No rendering knowledge required.<br />
            Upload your track — WizAnimate™ does the rest.
          </p>
          <NavLink
            href={WIZANIMATE_STUDIO_PAGE}
