        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div>
            ...
            >
              ...
              The Image Creation Studio
            </div>
            <h1 className="text-5xl md:text-6xl font-black leading-[1.05] mb-6 text-white">
              Any image.<br />
              <span style={{ color: ACCENT }}>Any style.</span><br />
              Instantly.
            </h1>
            <p className="text-white/50 text-lg leading-relaxed mb-10 max-w-lg">
              WizImage™ generates professional images in 6 art styles — from cinematic photorealism to anime, oil painting, and 3D render — at up to 4K resolution.
            </p>
        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="text-center mb-12">
            ...
            <p className="text-white/40 text-base max-w-xl mx-auto">
              The same prompt generates completely different results in each style — choose the visual language that fits your project.
            </p>
          </div>
          <StyleSelectorPanel />
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-white/45 text-base mb-8 max-w-xl mx-auto">
            One prompt. Six art styles. Professional quality at up to 4K — ready in seconds.
          </p>
          <NavLink
            href={WIZIMAGE_STUDIO_PAGE}
