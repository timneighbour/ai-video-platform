...
const FAQS = [
 ...
 { q: "Can I use the videos commercially?", a: "Yes — all generated shorts are yours to download and use in your own projects, including brand content, sponsored posts, and paid promotion. Full licensing terms are under review and will be published shortly." },
...
export default function WizShortsProductPage() {
 ...
 >
 <Zap className="w-3 h-3" />The Short-Form Studio
 </div>

 {/* P5 — Larger, stronger headline */}
 <h1 className="text-5xl md:text-7xl font-black leading-[1.02] mb-6 text-white tracking-tight">Stop the scroll.<br />
 <span
 style={{
 ...
 <p className="text-white/55 text-xl leading-relaxed mb-8 max-w-2xl mx-auto">WizShorts™ generates platform-optimised short-form videos for TikTok, YouTube Shorts, Instagram Reels, and Snapchat Spotlight — native 9:16, Hook/Story/CTA structure, auto-captions.
 </p>
 </div>
 ...
 >
 <Zap className="w-4 h-4" />Create Your Short
 ...
 >
 <Zap className="w-3 h-3" />Format Showcase
 </div>
 {/* P5 — Larger section heading */}
 <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">The Hook/Story/<span style={{ color: ACCENT }}>CTA structure</span>
 </h2>
 <p className="text-white/45 text-base max-w-xl mx-auto">Every WizShorts™ video follows the proven 3-part structure that drives the highest watch-through and engagement rates across all platforms.
 </p>
 </div>
 ...
 {/* P5 — Larger heading */}
 <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-14 tracking-tight">From brief to <span style={{ color: ACCENT }}>platform-ready short</span>
 </h2>
 <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
 ...
 {/* P5 — Larger heading */}
 <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-14 tracking-tight">Built for short-form,<br />
 ...
 {/* P5 — Larger heading */}
 <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-14 tracking-tight">The short-form studio<br />
 ...
 style={{ border: `1px solid ${ACCENT}35`, background: `${ACCENT}0a`, color: ACCENT }}
 >
 <Zap className="w-3 h-3" />Start Creating
 </div>
 {/* P8 — Stronger headline */}
 <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-5 tracking-tight">Ready to stop the scroll?
 </h2>
 {/* P8 — Addresses creator hesitation */}
 <p className="text-white/55 text-lg mb-4 max-w-xl mx-auto">No editing. No filming. No experience required.
 </p>
 <p className="text-white/40 text-base mb-10 max-w-xl mx-auto">Describe your idea — WizShorts™ writes the script, builds the visuals, adds captions, and exports platform-ready for TikTok, YouTube Shorts, Reels, and Spotlight.
 </p>
 <NavLink
 href={WIZSHORTS_STUDIO_PAGE}
 ...
 >
 <Zap className="w-5 h-5" />Open WizShorts™ Studio
