    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-white/10">
        <div className="container flex h-16 items-center justify-between">
          ...
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663500868908/ALJHDNsuNA7bExFuoQZUsx/wizvid-logo-transparent_fcdb69d6.png" alt="WizVid" className="h-20 w-auto object-contain" />
          <div className="w-24" />
        </div>
      </div>
