    ...
    <div className="min-h-screen bg-background text-white">
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-xl border-b border-white/8">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/" className="text-sm text-muted-foreground hover:text-white transition-colors">← Back to Home</Link>
        </div>
      </nav>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-10">
          ...
          <p className="text-muted-foreground text-sm">Last updated: 18 April 2026</p>
        </div>
      ...
      <footer className="border-t border-white/8 py-8 mt-16">
        <div className="max-w-4xl mx-auto px-6 flex flex-wrap gap-4 text-sm text-muted-foreground">
