      ...
      <div className="border-b border-border/40">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-1">
            <a href="/dashboard" className="inline-flex items-center gap-2 text-sm font-medium text-white/60 hover:text-white transition-colors px-3 py-2">
              <ArrowLeft className="h-4 w-4" />
              Back
            </a>
            <a href="/" className="inline-flex items-center gap-2 text-sm font-medium text-white/60 hover:text-white transition-colors px-3 py-2">
              ...
              {subLoading ? (
                ...
                <>
                  ...
                  <div className="flex gap-2 pt-4">
                    <a href="/subscribe" className="inline-flex items-center justify-center rounded-md border border-white/25 bg-white/5 text-white px-4 py-2 text-sm font-medium hover:bg-white/10 hover:border-white/40 transition-colors">
