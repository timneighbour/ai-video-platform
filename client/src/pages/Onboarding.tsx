...
const options = [
  ...
  },
  {
    href: '/wizpilot',
    title: 'WizPilot™',
    subtitle: 'AI Video Autopilot',
    description: 'Describe your vision and WizPilot™ orchestrates the full pipeline — script, visuals, audio, and render.',
    isPopular: false,
    icon: Play,
    ...
    tag: 'Autopilot',
    tagColor: 'from-[#f59e0b] to-[#fcd34d]',
    stats: ['Full pipeline', 'One prompt', 'Cinema grade'],
  },
  {
