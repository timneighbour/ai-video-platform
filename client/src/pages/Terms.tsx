      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-[#d4d4d8] leading-relaxed">
          ...
          <section>
            ...
            <p>You must be at least 13 years old to use WIZ AI. By using the Service, you represent that you meet this requirement. Users under 18 must have parental consent.</p>
          </section>
          ...
          <section>
            ...
            <p>You agree not to use WIZ AI to:</p>
          ...
          <section>
            ...
            <p><strong>Your input content:</strong> You retain ownership of any audio, images, or text you upload to WIZ AI.</p>
            <p className="mt-2"><strong>AI-generated output:</strong> Videos generated by WIZ AI are provided to you under a non-exclusive licence. You may use, share, and monetise AI-generated videos for personal and commercial purposes, subject to the following:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          <section>
            ...
            <p>To the maximum extent permitted by law, WIZ AI and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill, arising from your use of the Service. Our total liability to you for any claim shall not exceed the amount you paid us in the 12 months preceding the claim.</p>
          </section>
