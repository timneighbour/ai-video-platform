...
const WIZVIDEO_CONTENT: RichProductContent = {
  ...
  subheadline:
    "WizVideo™ transforms any audio track into a complete, scene-by-scene cinematic music video — with AI-generated visuals, lyric sync, style consistency, and a full render in minutes.",
  whatItDoes:
    "WizVideo™ is WIZ AI's end-to-end music video creation engine. Upload your track — or create music with WizScore™ — and WizVideo™ generates a full scene-by-scene storyboard, animates every scene with AI visuals, syncs cuts to your beats and lyrics, and renders a complete music video ready to publish. No editing skills. No crew. No studio.",
  capabilities: [
