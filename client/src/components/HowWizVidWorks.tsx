...
const STEPS = [
  {
    ...
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663500868908/ALJHDNsuNA7bExFuoQZUsx/how-wizvid-step1-jcSDdMGid4U5bcJS9RyqcC.webp",
  ...
  },
  {
    ...
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663500868908/ALJHDNsuNA7bExFuoQZUsx/how-wizvid-step2-bPF4mhHvMT8XsxFhq62PaA.webp",
    accent: "from-primary to-primary/40",
  ...
  },
  {
    ...
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663500868908/ALJHDNsuNA7bExFuoQZUsx/how-wizvid-step3-bpKpnghdQXbFzUMp7ThjMX.webp",
    accent: "from-[--color-gold] to-primary/40",
  ...
  },
  {
    ...
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663500868908/ALJHDNsuNA7bExFuoQZUsx/how-wizvid-step4-VZ8W8dfCJsNa9gSqQWYuYS.webp",
    accent: "from-primary to-primary/40",
  ...
  },
  {
    ...
    accent: "from-muted-foreground to-primary/40",
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mt-16">
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-primary to-primary/40 text-white font-bold text-base hover:from-primary hover:to-primary/40 transition-all duration-300 shadow-[0_0_40px_rgba(139,92,246,0.4)] hover:shadow-[0_0_60px_rgba(139,92,246,0.5)]"
            onClick={(e) => { e.preventDefault(); window.location.href = "/music-video/create"; }}
          >
            Start Creating
            <span className="text-white/70">→</span>
          </a>
          <p className="text-xs text-white/30 mt-3">No credit card required · 2 free Build Credits on sign-up</p>
        </div>
      </div>
    </section>
  );
