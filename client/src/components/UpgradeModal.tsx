...
import { Sparkles, Zap, Infinity, X, Rocket, Download, PartyPopper } from "@/lib/icons";
...
const TRIGGER_CONTENT = {
  limit: {
    ...
    body: "You're on a roll! Upgrade to Creator for 800 credits/month, no watermarks, and faster building.",
  },
  download: {
    icon: Download,
  ...
  milestone: {
    ...
    body: "You've created multiple videos — you're clearly a creator! Upgrade to Creator for 800 credits/month and no watermark.",
  },
  watermark: {
    icon: Sparkles,
...
const CREATOR_FEATURES = [
  { icon: <Infinity className="w-4 h-4" />, text: "800 credits/month included" },
