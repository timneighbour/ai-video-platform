...
const PRODUCTS: Product[] = [
  {
    ...
    cardVisual: <img src={CARD_BG_AUDIO} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" width="740" height="494" />,
  ...
  },
  {
    ...
    cardVisual: <img src={CARD_BG_IMAGE} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" width="740" height="494" />,
  ...
  },
  {
    ...
    cardVisual: <img src={CARD_BG_VIDEO} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" width="740" height="494" />,
  ...
  },
  {
    ...
    cardVisual: <img src={CARD_BG_SHORTS} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" width="740" height="494" />,
  ...
  },
  {
    ...
    cardVisual: <img src={CARD_BG_ANIMATE} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" width="740" height="494" />,
  ...
  },
  {
    ...
    cardVisual: <img src={CARD_BG_SCRIPT} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" width="740" height="494" />,
