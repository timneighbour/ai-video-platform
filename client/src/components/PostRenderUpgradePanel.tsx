...
const AUDIO_META: Record<AudioTier, { label: string; description: string; badge?: string }> = {
  ...
  enhanced:  { label: "WizSound Enhance",      description: "Stereo widening + EQ" },
  cinematic: { label: "WizSound Cinematic",    description: "Spatial depth, −14 LUFS master", badge: "Recommended" },
};
