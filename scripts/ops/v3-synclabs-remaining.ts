/**
 * v3 SyncLabs Corrected Pass — S07, S09, S12
 * S03 is already done. This script handles the remaining 3 scenes.
 * Uses curl for download to avoid the https.get redirect issue.
 */
...
async function main() {
  console.log("=== SyncLabs Corrected Pass — S07, S09, S12 ===");
  console.log("(S03 already completed)\n");
