...
export const SUBSCRIPTION_PLANS = {
  ...
  starter: {
    ...
    credits: 320,      // 320 monthly credits (reset each cycle)
    videosPerMonth: 2,
    maxVideosPerMonth: 2,
    maxVideoSeconds: 60,
    maxScenesPerVideo: 8,
    ...
    popular: false,
    features: [
      "320 credits/month (resets monthly)",
      "~2 WizVideo builds (8 scenes each)",
  ...
  creator: {
    ...
    credits: 1000,     // 1,000 monthly credits (reset each cycle)
    videosPerMonth: 6,
    maxVideosPerMonth: 6,
    maxVideoSeconds: 90,
  ...
  studio: {
    name: "Studio",
    pricePerMonth: 199,
    pricePerYear: 1990, // £199 × 10 = £1,990 (2 months free)
    credits: 2000,      // 2,000 monthly credits (reset each cycle)
    videosPerMonth: 12,
    ...
    features: [
      "2,000 credits/month (resets monthly)",
      "~12 WizVideo builds (8–12 scenes)",
      "All 7 WIZ AI studios",
      "4K quality included",
      "Priority rendering",
...
export const TOPUP_PACKS = {
  spark: {
    ...
    priceGbp: 12,
    pricePence: 1200,
    bestFor: "Quick top-up · ~5 WizVideo scenes",
    cta: "Add 100 Credits",
    popular: false,
    badge: null as string | null,
    stripePriceId: process.env.STRIPE_TOPUP_SPARK_PRICE_ID ?? "",
  },
  boost: {
    key: "boost",
    name: "Boost",
    ...
    priceGbp: 23,
    pricePence: 2300,
    bestFor: "~1 full WizVideo (8 scenes)",
    cta: "Add 200 Credits",
    popular: false,
    badge: null as string | null,
    stripePriceId: process.env.STRIPE_TOPUP_BOOST_PRICE_ID ?? "",
  },
  boost_200: {
    key: "boost_200",
    name: "Boost 400",
    ...
    priceGbp: 45,
    pricePence: 4500,
    bestFor: "~2 full WizVideos · most popular",
    cta: "Add 400 Credits",
    popular: true,
  ...
  mega: {
    ...
    priceGbp: 109,
    pricePence: 10900,
    bestFor: "~6 full WizVideos · best value",
    cta: "Add 1,000 Credits",
    popular: false,
    badge: "Best Value" as string | null,
    stripePriceId: process.env.STRIPE_TOPUP_ELITE_PRICE_ID ?? "",
  },
} as const;
