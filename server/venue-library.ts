...
export const VENUE_LIBRARY: VenueEntry[] = [
  // ── Recording Studios ────────────────────────────────────────────────────
  {
    ...
    referenceImageUrl: "/manus-storage/air-studios-lyndhurst-hall-wide_f22229ba.jpg",
    interiorDNA: `LOCATION LOCK — AIR STUDIOS, LYNDHURST HALL, LONDON (MANDATORY — THIS IS THE ONLY ACCEPTABLE BACKGROUND). THE CEILING IS PALE PERIWINKLE BLUE / LAVENDER. THIS IS THE MOST IMPORTANT VISUAL DETAIL — THE CEILING MUST BE BLUE IN EVERY SINGLE SCENE. DO NOT USE A DARK CEILING. DO NOT USE A WHITE CEILING. THE CEILING IS ALWAYS PALE BLUE/LAVENDER. This is a converted Victorian Gothic church used as a world-class recording studio. MANDATORY ARCHITECTURAL ELEMENTS that MUST appear in EVERY scene: (1) Fan-vaulted Gothic ceiling painted PALE PERIWINKLE BLUE / LAVENDER between white plaster fan-vault ribs — THE CEILING IS BLUE, THIS IS NON-NEGOTIABLE. (2) Large suspended hexagonal wooden acoustic canopy with geometric triangular lattice of dark warm mahogany beams hanging centrally from ceiling. (3) Multiple tall Gothic-arched windows with decorative tracery in two tiers, letting in cool blue-white diffused daylight through frosted/leaded glass. (4) Continuous curved wooden balcony/gallery at mid-height with warm honey/oak wood panelling and ornate carved decorative arches. (5) Classical pipe organ in dark mahogany housing with silver-grey metal pipes at far end. (6) Warm honey-brown herringbone parquet floor, highly polished. LIGHTING: warm golden/amber tungsten spotlights contrasting with cool blue-white window light. ATMOSPHERE: full symphony orchestra in traditional formation, music stands, conductor's podium, Steinway concert grand piano in black lacquer. FINAL RULE: NO chandeliers. NO tiered audience seating. NO dark ceiling. NO plain white ceiling. THE CEILING IS ALWAYS PALE BLUE/LAVENDER. EVERY IMAGE MUST SHOW THE BLUE GOTHIC VAULTED CEILING.`,
  },
  {
