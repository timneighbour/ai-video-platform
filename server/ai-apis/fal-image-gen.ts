...
export const VENUE_DNA: Record<string, string> = {
  concert_hall: `Air Studios Lyndhurst Hall London — converted Victorian Gothic church interior. MOST DISTINCTIVE ELEMENT: large suspended hexagonal wooden acoustic canopy with geometric triangular lattice of dark warm mahogany beams hanging centrally from ceiling. Fan-vaulted Gothic ceiling painted pale periwinkle blue/lavender between white plaster fan-vault ribs. Multiple tall Gothic-arched windows with decorative tracery in two tiers letting in cool blue-white diffused daylight through frosted/leaded glass. Continuous curved wooden balcony/gallery at mid-height with warm honey/oak wood panelling and ornate carved decorative arches. Classical pipe organ in dark mahogany housing with silver-grey metal pipes at far end. Warm honey-brown herringbone parquet floor, highly polished. Warm golden/amber tungsten spotlights contrasting with cool blue-white window light. Full symphony orchestra in traditional formation, music stands, conductor's podium, Steinway concert grand piano in black lacquer, forest of professional microphone stands. Cinematic depth of field, photorealistic, 8K quality. NO chandeliers. NO tiered audience seating. NO dark ceiling — ceiling is pale blue/lavender.`,
